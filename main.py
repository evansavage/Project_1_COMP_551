...
X_wine2a = X_wine[:,:]
k_fold_cross_validation(5, X_wine2a, Y_wine2, wine_LDA, 5, shuffle=12312, debug=True)
# k_fold_cross_validation(5, X_cancer2, Y_cancer2, cancer_LDA, 3, shuffle=222, debug=True)
